...
module.exports = class extends Generator {
    ...
    async prompting () {
        ...
        const questions = [{
            type : 'input',
            name : 'version',
            message : 'Please specify the Hyperledger Fabric version:',
            choices : [
                {name : '1.4', value : '1.4.1'},
                {name : '2.0', value : '2.0.0-alpha'}
            ],
        ...
        if(this.options.version === '2.0.0-alpha') {
            this.options.thirdPartyVersion = '0.4.15';
        } else {
            this.options.thirdPartyVersion = '0.4.15';
        }
    }
